...
#ifdef _WIN32
// Code in od-win32/bsdsock.cpp for Win32 platform
#else

// FIXME: Review code and compare against od-win32/bsdsock.cpp. Many instances
// of put_long must be converted to trap_put_long...
// FIXME: Also trap_call_add_dreg (etc)
